            ...
            <ResizablePanel defaultSize={35} minSize={25} maxSize={50}>
              <div className="h-full flex flex-col bg-white dark:bg-neutral-900">
                ...
                <div className="h-14 flex items-center px-6 border-b border-neutral-200/60 dark:border-neutral-700/60">
                  <h1 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 tracking-tight">Super duper Melaniia's generator</h1>
                </div>
            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white dark:bg-neutral-900">
                ...
                <div className="h-14 border-b border-neutral-200/60 dark:border-neutral-700/60 px-6 flex items-center justify-between bg-neutral-50/50 dark:bg-neutral-800/50">
                  ...
                  >
                    <TabsList className="bg-white/60 dark:bg-neutral-800/60 border border-neutral-200/60 dark:border-blue-500/40 p-0.5 h-9 shadow-sm">
                  ...
                  {activeView === "preview" ? (
                    ...
                    >
                      ...
                      <ResizablePanel
                        ...
                        maxSize={50}
                      >
                        <div className="h-full bg-neutral-50 dark:bg-neutral-800 border-r border-neutral-200 dark:border-neutral-700">
                          <FileTree />
                        </div>
                      </ResizablePanel>
